...
//         if(t === tab){
//             tabName.classList.add("bg-black", "text-white");
//             tabName.classList.remove("bg-white", "text-[#64748B]");
//         }
//         else{
//             tabName.classList.remove("bg-black", "text-white");
//             tabName.classList.add("bg-white", "text-[#64748B]");
//         }
